...
from kivy_django_restful.uix.popup.base import FlatPopupBase
from kivy_django_restful.uix import colors
from kivy_django_restful.utils import write_to_log, background_thread
from app import settings
from .text import TextInput


Builder.load_string('''
#: import icon kivy_django_restful.fonts.icon
